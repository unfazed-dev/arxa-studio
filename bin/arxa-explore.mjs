...
//     [--cwd <project dir>] [--provider zai-wallet] [--model glm-4.6v] \
//     [--effort off|low|medium|high|max] [--summarize]
//
...
const opts = { options: [], provider: 'zai-wallet', model: 'glm-4.6v', cwd: process.cwd() }
