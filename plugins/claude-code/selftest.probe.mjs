...
const forceProbe = new Probe({ query: forceQ, binary: '/opt/bin/claude', env: {}, now: () => 0 })
...
const timeoutProbe = new Probe({ query: abortQuery, binary: '/opt/bin/claude', env: {}, now: () => 0, timeoutMs: 20 })
let backstopTimer
