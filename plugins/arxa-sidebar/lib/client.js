		...
		function TrashSection({ t }) {
			...
			const entryRow = (e, glyph, onRestore, onPurge) => (0, react_jsx_runtime.jsxs)("div", {
				...
				children: [
					...
					// edge-to-edge (sessionRow carries no gap for bare children).
...
"menu.org.trash": "Move to Trash",
			...
			"trash.orgSection": "Trashed organisations",
			"trash.projectSection": "Trashed projects",
...
"menu.org.trash": "移到废纸篓",
			...
			"trash.orgSection": "已删除的组织",
			"trash.projectSection": "已删除的项目",
