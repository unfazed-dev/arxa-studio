		...
		* directory picker flow stays permanently unavailable. */
		...
		function ArxaDirRows({ dir, depth, mode }) {
			...
			const fileRow = (relPath, name, d) => (0, react_jsx_runtime.jsxs)("div", {
				...
				children: [
					// Fixed-width spacer, NOT the classed empty slot: the slot's
					// width is flex-derived and WKWebView collapsed it on the
					// focused row — the first file read ~20px outdented vs its
					// siblings (user screenshot 2026-09-01). A hard 24px box
					// aligns every sibling's text in every engine.
					(0, react_jsx_runtime.jsx)("span", { style: { flex: "none", width: 24, flexBasis: 24 } }),
			...
			return (0, react_jsx_runtime.jsx)(_deepseek_ai_dsh_client_ui_primitives.Modal, {
				...
				children: (0, react_jsx_runtime.jsxs)("div", { children: [
					...
					(0, react_jsx_runtime.jsxs)(react_jsx_runtime.Fragment, { children: [
						...
						] }) : (0, react_jsx_runtime.jsx)("div", { role: "alert", style: { marginTop: 10, fontSize: 12, color: "var(--dsw-alias-status-danger, #e5484d)" }, children: t("org.create.exists.nonempty") })),
...
"menu.org.trash": "移到废纸篓",
			...
			"org.create.preview": "将创建于",
			"org.create.exists.nonempty": "该文件夹已存在且不为空 — 请更改名称或位置。",
			"org.create.exists.org": "{name} 已在这里。",
			"org.create.exists.open": "改为打开它",
