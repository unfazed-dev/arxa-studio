...
// The original package stays untouched in node_modules as reference.
		...
		* directory picker flow stays permanently unavailable. */
		...
		function TrashSection({ t }) {
			// D80: the trash is a PERMANENT, discoverable row — hairline divider
			// on top, count badge, expandable restore list. Visible (dimmed) even
			// when empty: the org menu trash toggle is gone; this row is the one door.
			...
			return (0, react_jsx_runtime.jsxs)("div", {
				style: { borderTop: "1px solid var(--dsw-alias-border-l2, rgba(255,255,255,0.08))", marginTop: 8, padding: "6px 4px 8px", opacity: rows.length === 0 ? 0.45 : 1 },
				children: [
					(0, react_jsx_runtime.jsxs)("div", {
						role: "button",
						tabIndex: 0,
						...
						children: [
							...
							rows.length > 0 && (0, react_jsx_runtime.jsx)("span", { style: { fontSize: 11, opacity: 0.7, border: "1px solid var(--dsw-alias-border-l2)", borderRadius: 8, padding: "0 6px" }, children: String(rows.length) }),
					...
					open && rows.length === 0 && (0, react_jsx_runtime.jsx)("div", { style: { fontSize: 12, opacity: 0.55, padding: "4px 8px 2px" }, children: t("trash.empty") }),
					...
					open && rows.length > 0 && (0, react_jsx_runtime.jsx)("button", {
					onClick: () => restore(null),
					style: { marginTop: 4, marginLeft: 12, border: "1px solid var(--dsw-alias-border-l2)", background: "transparent", color: "inherit", borderRadius: 6, fontSize: 11, padding: "2px 8px", cursor: "pointer" },
		...
		*/
		function apply(ctx) {
			ctx.effect(() => ctx.locale.register(NS, { zh: { ...zh, ...zhOver }, en: { ...en, ...enOver } }), "arxa-sidebar-workspace: dictionaries");
