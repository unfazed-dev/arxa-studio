		...
		function TrashSection({ t }) {
			...
			const entryRow = (e, glyph, onRestore, onPurge) => (0, react_jsx_runtime.jsxs)("div", {
				...
				children: [
					...
					// edge-to-edge (row CSS carries no gap for bare children). D92:
					// 8px, the standard icon-button rhythm — 4px read as touching
					// (iconButton is a bare 16×16, padding 0, so the gap IS the
					// glyph-to-glyph distance).
					(0, react_jsx_runtime.jsx)("span", { style: { display: "flex", gap: 8, flex: "none", alignItems: "center" }, children: [
