...
// The original package stays untouched in node_modules as reference.
		...
		* the stock renderer read as ages from 1970. */
		 ...
		 * every boot). This slot face replaces it with the arxa way;
		 * without a picked workspace the hero composer stays inert, so no
		 * raw session can be born from the hero. */
