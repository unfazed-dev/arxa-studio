...
// The original package stays untouched in node_modules as reference.
		...
		* the stock renderer read as ages from 1970. */
		...
		function ArxaAgentRowActions({ row, t, busy, onAct }) {
			return (0, react_jsx_runtime.jsx)("span", {
		...
		function ArxaAgentControl({ kind, sessionId, count, t }) {
			const [open, setOpen] = (0, react.useState)(false);
			...
			const load = (0, react.useCallback)(() => {
				ORG_POST("agent.list", { sessionId: sessionId }).then((b) => {
					const r = (b && b.result) || {};
					setNote("");
					/* A cold session's jobs are UNREACHABLE, not absent — the host
					 * says which, and saying "no jobs" for either would be wrong. */
					if (kind === "jobs" && r.jobsReadable === false) { setRows([]); setNote(t("agents.why.owner-not-live")); return; }
					setRows(kind === "jobs" ? (r.jobs || []) : (r.subagents || []));
					...
					children: [
						...
						(rows || []).map((row) => (0, react_jsx_runtime.jsxs)("span", {
							...
							children: [
								...
								(0, react_jsx_runtime.jsx)(ArxaAgentRowActions, { row: row, t: t, busy: busy, onAct: act })
							]
						}, row.id)),
						(0, react_jsx_runtime.jsx)("button", {
							type: "button",
							className: "aXa_agentDetails",
							onClick: () => { setOpen(false); openAgentPanel(kind, sessionId); },
		...
		function ArxaJobsPlaceholder({ sessionId, useSessions, t }) {
			...
			if (count > 0) return (0, react_jsx_runtime.jsx)(ArxaAgentControl, { kind: "jobs", sessionId: sessionId, count: count, t: t });
		...
		if (typeof document !== "undefined" && document.querySelector("style[data-plugin-css=arxa-sidebar-empty-state]") === null) {
			...
			tag.textContent = "[data-arxa-hero-guide]{font-size:12.5px;opacity:.72;line-height:1.55;max-width:470px}"
				...
				+ ".aXa_agentRow:hover .aXa_agentActs,.aXa_agentActs:focus-within{opacity:1}"
