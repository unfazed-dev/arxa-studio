...
// The original package stays untouched in node_modules as reference.
			...
			(0, react.useEffect)(() => {
				const apply = () => {
					for (const b of document.querySelectorAll(".aXa_sb_newSession")) {
						b.disabled = !selectedRowId;
						b.title = selectedRowId ? "" : t("newSession.selectFirst");
					}
				};
				apply();
		...
		* reserved for server-truth changes. */
			...
			return (0, react_jsx_runtime.jsx)(_deepseek_ai_dsh_client_ui_primitives.Modal, {
				...
				children: (0, react_jsx_runtime.jsxs)("div", { children: [
					showSignin && (0, react_jsx_runtime.jsxs)(react_jsx_runtime.Fragment, { children: [
						(0, react_jsx_runtime.jsx)("div", { style: { fontSize: 12, opacity: 0.75, marginBottom: 8 }, children: t("github.signin.desc") }),
						(0, react_jsx_runtime.jsx)(_deepseek_ai_dsh_client_ui_primitives.Button, {
							variant: "primary",
							disabled: busy,
							onClick: signin,
							children: busy ? t("github.signin.busy") : t("github.signin.button")
						})
					] }),
			...
			return (0, react_jsx_runtime.jsx)("div", {
				...
				children: (0, react_jsx_runtime.jsxs)("div", {
					...
					children: [
						...
						(0, react_jsx_runtime.jsx)("span", { style: { display: "inline-block", border: "1px solid var(--dsw-alias-border-l2)", borderRadius: 8, padding: "7px 16px", fontSize: 13 }, children: t("welcome.cta") })
					]
				})
			});
		}
		...
		const enOver = {
			...
			"welcome.cta": "Create organisation",
		...
		function apply(ctx) {
			...
			const browserInjected = () => ({
				...
				open: (sessionId) => {
					...
					if (orgId !== void 0) orgStore.mutate("session.open", { orgId, sessionId }).catch(() => {});
				},
