...
// dsh 0.1.2-rc.1 (2026-09-05) moved BOTH ends of the D63 wiring: the producer
// is no longer the client-runtime SessionManager summary field — it is
// dsh-client-ui-session's UiSession service, publishing a pendingInteractions
// MAP through slots.provideRoot as the framework's standard
// sessionPendingInteraction hook. The stock rows consume the map via
// visiblePendingKind; the sidebar overrides the hook at the OrgBrowser
// boundary with the org-derived map. Pin both stock reads, our derivation,
// and the union (the old summary-field spreads are gone from the stock).
