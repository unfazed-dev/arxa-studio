...
window.__ModuleLoader__.load({
  ...
  factory: (require) => {
    ...
    const CSS = [
      '.arxa-ps-root{display:inline-flex;align-items:center;position:relative;white-space:nowrap;font-size:11px;order:1;margin-left:-16px}', // 12px between the CIRCLES: the row's 12px gap plus both triggers' 7.5px ring padding, minus 12. At 6px the two 28px hover washes overlapped (2026-09-06).
