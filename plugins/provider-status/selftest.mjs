...
// --- the wiring rule that made the pill vanish on every provider
{
  ...
  assert.ok(/order:1;margin-left:-16px\}/.test(clientSrc), 'the usage CIRCLE sits 12px from the context circle: closer than the row gap, but the hover washes never overlap')
